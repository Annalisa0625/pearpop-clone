  ...
  const copy =
    locale === "ja"
      ? {
          ...
          title: "企業向け",
          body:
            "Trend Mart は、日本・海外ブランドや消費者向け事業者が、日本 / アジア市場向けの施策に合うマイクロクリエイターを探し、参考条件カードを見ながら直接依頼できるサービスです。承認後は案件ページ内でチャット、納品確認、完了承認まで一貫して管理できます。",
          supportLine:
          ...
          valueTitle: "Trend Mart が向いている理由",
