...
const en: CreatorSignupCopy = {
  ...ja,
  step: "STEP", uiLanguage: "UI language", displayTitle: "Basic info", displayBody: "You can edit this later.", displayName: "Username", displayNamePlaceholder: "Example: Yuna Beauty", country: "Country", gender: "Gender", birthDate: "Date of birth",
  ...
  menuTitle: "Menus", menuBody: "Create at least one menu brands can order.", menuType: "Menu type", customMenuName: "Menu name", customMenuPlaceholder: "Example: Instagram live stream", priceLabel: "Price (JPY)", price: "Example: 11,000", minimumPrice: "Please enter JPY 3,000 or more", addMenu: "Add menu",
  termsTitle: "Confirm", termsLabel: "I agree to the Terms", privacyLabel: "I agree to the Privacy Policy", termsLink: "Terms", privacyLink: "Privacy Policy", continue: "Next", back: "Back", finish: "Sign up", loading: "Processing...", preparing: "Preparing...", preparingTitle: "Preparing your profile", preparingBody: "Almost done. You can edit your details later. Adding more menus can increase your chances of receiving orders.", selectPlease: "Please select", login: "Login", reset: "Reset",
...
const ko: CreatorSignupCopy = {
  ...ja,
  uiLanguage: "UI 언어", displayTitle: "기본 정보", displayBody: "입력한 내용은 나중에 수정할 수 있어요.", displayName: "활동명", displayNamePlaceholder: "예: Yuna Beauty", country: "활동 국가", gender: "성별", birthDate: "생년월일",
  ...
  menuTitle: "PR 메뉴", menuBody: "브랜드가 의뢰할 수 있는 PR 메뉴를 1개 이상 만들어 주세요.", menuType: "PR 유형", customMenuName: "PR 메뉴명", customMenuPlaceholder: "예: Instagram 라이브 방송", priceLabel: "금액(엔)", price: "예: 11,000", minimumPrice: "3,000엔 이상 입력해 주세요", addMenu: "PR 메뉴 추가",
  termsTitle: "약관 동의", termsLabel: "이용약관에 동의합니다", privacyLabel: "개인정보 처리방침에 동의합니다", termsLink: "이용약관", privacyLink: "개인정보 처리방침", continue: "다음", back: "이전", finish: "가입 완료", loading: "처리 중...", preparing: "프로필 준비 중...", preparingTitle: "프로필을 준비하고 있어요", preparingBody: "곧 완료됩니다. 입력한 내용은 나중에 수정할 수 있으며, PR 메뉴를 더 추가하면 브랜드와 만날 기회도 늘어납니다.", selectPlease: "선택해 주세요", login: "로그인", reset: "처음부터",
...
const zhTW: CreatorSignupCopy = {
  ...ja,
  uiLanguage: "介面語言", displayTitle: "基本資料", displayBody: "這些資料之後都可以修改。", displayName: "創作者名稱", displayNamePlaceholder: "例如：Yuna Beauty", country: "活動國家／地區", gender: "性別", birthDate: "出生日期",
  ...
  menuTitle: "PR 服務", menuBody: "請建立至少一項可供品牌委託的 PR 服務。", menuType: "PR 類型", customMenuName: "PR 服務名稱", customMenuPlaceholder: "例如：Instagram 直播", priceLabel: "金額（日圓）", price: "例如：11,000", minimumPrice: "請輸入 3,000 日圓以上的金額", addMenu: "新增 PR 服務",
  termsTitle: "確認並同意", termsLabel: "我同意使用條款", privacyLabel: "我同意隱私權政策", termsLink: "使用條款", privacyLink: "隱私權政策", continue: "下一步", back: "返回", finish: "完成註冊", loading: "處理中...", preparing: "正在準備個人檔案...", preparingTitle: "正在建立你的個人檔案", preparingBody: "快完成了！所有資料之後都可以修改；新增更多 PR 服務，也能增加被品牌看見的機會。", selectPlease: "請選擇", login: "登入", reset: "重新開始",
