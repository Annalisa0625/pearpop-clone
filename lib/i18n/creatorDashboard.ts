...
export function getCreatorDashboardCopy(
  ...
  return {
    ...base,
    startMartBody: paidMarketplaceEnabled
      ? base.startMartBody
      : base.startPublicProfileBody,
    orders: orderCopy[0],
    ordersBody: orderCopy[1],
  };
}
